...
/**
 * Main site footer with links, app store badges, and social links.
 */
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-3 mt-6">
              <a
                ...
                className="inline-flex items-center justify-center h-10 px-4 bg-navy-900 text-white text-xs font-medium rounded-lg hover:bg-navy-800 transition-colors"
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-500">
              © 2026 Tuknang. Made with love in the Philippines.
            </p>
