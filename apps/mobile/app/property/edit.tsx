...
export default function EditPropertyScreen() {
  ...
  const uploadCoverImage = async () => {
    if (!coverImage || coverImage === originalProperty?.cover_image_url) return originalProperty?.cover_image_url;
    ...
    try {
      ...
      return originalProperty?.cover_image_url;
    }
  };
...
const styles = StyleSheet.create({
  ...
  imagePickerContainer: { borderRadius: BorderRadius.lg, overflow: 'hidden', backgroundColor: Colors.neutral.gray100 },
  ...
  imagePlaceholderText: { fontSize: Typography.fontSize.md, color: Colors.neutral.gray500 },
